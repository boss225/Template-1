...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', 'ngCartItem', 'store','Notification', function ($rootScope, ngCartItem, store,Notification) {
        ...
        this.addItem = function (id, name , img, price, quantity, data) {

            var inCart = this.getItemById(id);

            if (typeof inCart === 'object'){
                //Update quantity of an item if it's already in the cart
                Notification.warning('Đã cập nhập số lượng');
                inCart.setQuantity(quantity, true);
            } else {
                var newItem = new ngCartItem(id, name, img, price, quantity, data);
        ...
        this.removeItemById = function (id) {
            ...
            $rootScope.$broadcast('ngCart:itemRemoved', {});
            $rootScope.$broadcast('ngCart:change', {});
            Notification.error('Đã xóa khỏi giỏ hàng');
        };
        ...
        this.$restore = function(storedCart){
            ...
            angular.forEach(storedCart.items, function (item) {
                _self.$cart.items.push(new ngCartItem(item._id,  item._name, item._img, item._price, item._quantity, item._data));
            });
            this.$save();
        };
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        var item = function (id, name, img, price, quantity, data) {
            this.setId(id);
            this.setName(name);
            this.setImg(img);
            this.setPrice(price);
