...
(function (f, g, k) {
    var l = {init: function (a, b) {
        ...
        gestures: function () {
            ...
            var a;
            0 > this.newRelativeX ? (a = "right", this.playDirection = ">") : (a = "left", this.playDirection = "<");
            return a
    ...
    f.fn.owlCarousel.options = {items: 5, itemsCustom: !1, itemsDesktop: [1199, 4], itemsDesktopSmall: [979, 3], itemsTablet: [768, 2], itemsTabletSmall: !1, itemsMobile: [479, 2], singleItem: !1, itemsScaleUp: !1, slideSpeed: 200, paginationSpeed: 800, rewindSpeed: 1E3, autoPlay: !1, stopOnHover: !1, navigation: !1, navigationText: ["<", ">"], rewindNav: !0, scrollPerPage: !1, pagination: !0, paginationNumbers: !1,
